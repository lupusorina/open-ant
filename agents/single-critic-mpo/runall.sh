...
run_sim () {
    ...
    echo "Using single critic: --ensemble 1"
    echo "=========================================="
    ...
    python3 "${SCRIPT}" \
        ...
        --wandb_run_name "sim1_seed_${seed}_singlecritic" \
        --wandb_group "mpo_singlecritic" \
        --wandb_mode online
...
run_continual () {
    ...
    python3 "${SCRIPT}" \
        ...
        --track_wandb \
        --wandb_project mpo-ant-continual \
        --wandb_run_name "sim2_seed_${seed}_singlecritic" \
        --wandb_group "mpo_singlecritic" \
        --wandb_mode online
