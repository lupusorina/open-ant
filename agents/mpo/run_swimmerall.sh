...
SCRIPT="mpo_acme_morelogs.py"

GPU_LIST=(2)

SEEDS=(1)
RUN_MODE="${1:-both}"
SIM1_EXP_NAME="mpo_swimmer"
SIM1_TOTAL_TIMESTEPS="2_000_000"
SIM2_TOTAL_TIMESTEPS="5_000_000"

RUNS_DIR="/data2/serenaliu_data/mpo_swimmer"

MODEL1_PATH="/home/serenaliu/caltech_linc_home/open-ant/sim/assets/swimmer.xml"
MODEL2_PATH="/home/serenaliu/caltech_linc_home/open-ant/sim/assets/swimmer_sim2.xml"

CONT_EXP_NAME="continual_mpo_swimmer"
